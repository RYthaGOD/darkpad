...
// Fixed Mainnet ALT Address if env var not set - Copied from original file
...
export const tokenList = ['sol', 'usdc', 'usdt', 'zec', 'ore', 'store'] as const;
export type TokenList = typeof tokenList[number];
export const splList = ['usdc', 'usdt', 'zec', 'ore', 'store'] as const;
...
export const tokens: Token[] = [
    ...
    // Truncated other tokens for brevity as we likely only need SOL/USDC for demo
]
